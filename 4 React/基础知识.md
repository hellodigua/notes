...
this.state.xxx 的方式不会重新渲染组件，应该使用 setState()
...
[学习 React 比你想象的要简单](https://juejin.im/post/599156cc6fb9a03c3a25db08)
